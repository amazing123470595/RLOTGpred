...
# from Env_new import PPOEnvZcc # 最简单的奖励
from Env import PPOEnvZcc # 用官方的Env
from Features import GetESM2
...
X_train, y_train, X_test, y_test, ratio = GetESM2(train_all, test_all)
