...
from Features import GetProtT5_T_4, GetCCP_4, GetTPEMPPS_CCP
...
model_name = "TPEMPPS_CCP"

# 全部数据集
test_negative = "../Dataset/test/fasta/neg_Independent.fasta"
test_positive = "../Dataset/test/fasta/pos_Independent.fasta"
train_negative = "../Dataset/train/fasta/neg_Training.fasta"
train_positive = "../Dataset/train/fasta/pos_Training.fasta"

X_train, y_train, X_test, y_test, ratio = GetTPEMPPS_CCP(train_negative, train_positive, test_negative, test_positive)
